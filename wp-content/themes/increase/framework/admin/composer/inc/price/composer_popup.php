...
<script type="text/javascript">
	...
	function insertShortcode() { 
		if (window.tinyMCE) {
			...
			shortcode_tag += '[pricing_table title="' + price_title + '" color="' + glow_type + '" price="' + price_text_price + '" buttontext="' + price_but_text + '" buttonlink="' + price_but_link + '"';
			...
			<table class="describe">
				<tbody>
					...
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
							<span class="alignleft">
								<label for="glow_type"><?php _e('Pricing Color', 'cmsmasters'); ?></label>
							</span>
						</th>
						<td class="field" style="padding-top:10px;">
							<select name="glow_type" id="glow_type">
								<option value="blue"<?php echo ($content != '' && $pricing_table['color'] && $pricing_table['color'] == 'blue') ? ' selected="selected"' : ''; ?>><?php _e('Blue', 'cmsmasters'); ?></option>
								<option value="green"<?php echo ($content != '' && $pricing_table['color'] && $pricing_table['color'] == 'green') ? ' selected="selected"' : ''; ?>><?php _e('Green', 'cmsmasters'); ?></option>
								<option value="yellow"<?php echo ($content != '' && $pricing_table['color'] && $pricing_table['color'] == 'yellow') ? ' selected="selected"' : ''; ?>><?php _e('Yellow', 'cmsmasters'); ?></option>
								<option value="red"<?php echo ($content != '' && $pricing_table['color'] && $pricing_table['color'] == 'red') ? ' selected="selected"' : ''; ?>><?php _e('Red', 'cmsmasters'); ?></option>
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr class="add_list_item" style="border-top:1px dotted #dfdfdf;">
						...
						<td class="field" style="padding-top:10px; padding-bottom:10px;">
							<input type="button" value="<?php _e('Add List Item', 'cmsmasters'); ?>" name="add_list_item" id="add_list_item" class="button" />
						</td>
					</tr>
				</tbody>
			</table>
