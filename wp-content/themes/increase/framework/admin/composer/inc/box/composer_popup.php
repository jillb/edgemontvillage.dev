...
<?php if ($type == 'block') { ?>
	function insertShortcode() { 
		if (window.tinyMCE) {
			...
			shortcode_tag += "[featured_block bgcolor=\"" + fb_glow + "\"";
			...
			if (jQuery('#wp-column_content-wrap').hasClass('tmce-active')) {
				tinyMCE.execCommand('mceRemoveControl', true, 'column_content');
			}
		...
		<div class="media-item">
			...
			<?php if ($type == 'block') { ?>
					...
					<tr>
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
							<span class="alignleft">
								<label for="fb_glow"><?php _e('Block Color', 'cmsmasters'); ?></label>
							</span>
						</th>
						<td class="field" style="padding-top:10px;">
							<select name="fb_glow" id="fb_glow">
								<option value="blue"<?php echo ($content != '' && $block['bgcolor'] && $block['bgcolor'] == 'blue') ? ' selected="selected"' : ''; ?>><?php _e('Blue', 'cmsmasters'); ?></option>
								<option value="green"<?php echo ($content != '' && $block['bgcolor'] && $block['bgcolor'] == 'green') ? ' selected="selected"' : ''; ?>><?php _e('Green', 'cmsmasters'); ?></option>
								<option value="yellow"<?php echo ($content != '' && $block['bgcolor'] && $block['bgcolor'] == 'yellow') ? ' selected="selected"' : ''; ?>><?php _e('Yellow', 'cmsmasters'); ?></option>
								<option value="red"<?php echo ($content != '' && $block['bgcolor'] && $block['bgcolor'] == 'red') ? ' selected="selected"' : ''; ?>><?php _e('Red', 'cmsmasters'); ?></option>
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr style="display:none;">
						...
						<td class="field" style="padding-top:10px;">
							<input type="text" value="<?php echo ($content != '' && $block['buttontext']) ? $block['buttontext'] : ''; ?>" name="fb_button_text" id="fb_button_text" class="popup_tr_value" />
						</td>
					</tr>
					<tr style="display:none;">
						<th class="label" valign="top" style="width:130px; padding-top:15px;" scope="row">
			...
			<?php } else if ($type == 'color') { ?>
					...
					<tr>
						...
						<td class="field" style="padding-top:10px;">
							<select name="cb_glow" id="cb_glow">
								<option value="blue"<?php echo ($content != '' && $color['bgcolor'] && $color['bgcolor'] == 'blue') ? ' selected="selected"' : ''; ?>><?php _e('Blue', 'cmsmasters'); ?></option>
								<option value="green"<?php echo ($content != '' && $color['bgcolor'] && $color['bgcolor'] == 'green') ? ' selected="selected"' : ''; ?>><?php _e('Green', 'cmsmasters'); ?></option>
								<option value="yellow"<?php echo ($content != '' && $color['bgcolor'] && $color['bgcolor'] == 'yellow') ? ' selected="selected"' : ''; ?>><?php _e('Yellow', 'cmsmasters'); ?></option>
								<option value="red"<?php echo ($content != '' && $color['bgcolor'] && $color['bgcolor'] == 'red') ? ' selected="selected"' : ''; ?>><?php _e('Red', 'cmsmasters'); ?></option>
							</select>
						</td>
					</tr>
					<tr>
...
<script type="text/javascript">
	jQuery(document).ready(function () { 
		...
		tinyMCE.execCommand('mceAddControl', true, 'column_content');
